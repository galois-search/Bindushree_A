...
REPORT_FILE = "Sidelnikov_GA_ALL_Results.txt"
CSV_SUMMARY = "Sidelnikov_GA_Summary.csv"
...
def run_ga_batch():
    ...
    with open(REPORT_FILE, "w", encoding='utf-8') as f:
        f.write("GENETIC ALGORITHM | SIDELNIKOV SEED BATCH REPORT\n")
        f.write("=" * 80 + "\n\n")
        ...
        for n in lengths:
            ...
            try:
                ...
                for gen in range(60):
                    population.sort(key=lambda x: safe_psl(x, n))
                    top_psl = safe_psl(population[0], n)
                ...
                final_psl = safe_psl(final_seq, n)
                ...
                excel_results.append({
                    ...
                    'Initial_PSL': init_psl, 'Optimized_PSL': final_psl, 'Improvement': init_psl - final_psl
                })
...
if __name__ == "__main__":
    print("🚀 Genetic Algorithm (SIDELNIKOV SEED)")
