...
REPORT_FILE = "Sidelnikov_BrestBoskovic_ALL_Results.txt"
CSV_SUMMARY = "Sidelnikov_BrestBoskovic_Summary.csv"
...
def run_brest_boskovic_batch():
    ...
    with open(REPORT_FILE, "w", encoding='utf-8') as f:
        f.write("BREST-BOSKOVIC | SIDELNIKOV SEED BATCH REPORT\n")
        f.write("=" * 80 + "\n\n")
...
if __name__ == "__main__":
    print("🚀 Brest-Boskovic (SIDELNIKOV SEED)")
